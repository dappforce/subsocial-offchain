...
var mongo = require("../adaptors/mongo");
...
var init = function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, mongo.connect()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
// more than one can be used asynchronously
var insertFromMongo = function (data) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, mongo.insert(data)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
module.exports = { init: init, insertFromMongo: insertFromMongo };
