...
class Change extends _types.Struct {
  constructor(value) {
    super({
...
class Blog extends _types.Struct {
  constructor(value) {
    super({
      id: BlogId,
      created: Change,
...
class BlogUpdate extends _types.Struct {
  constructor(value) {
    super({
...
class Post extends _types.Struct {
  constructor(value) {
    super({
      id: PostId,
      blog_id: BlogId,
...
class PostUpdate extends _types.Struct {
  constructor(value) {
    super({
...
class Comment extends _types.Struct {
  constructor(value) {
    super({
      id: CommentId,
...
class CommentUpdate extends _types.Struct {
  constructor(value) {
    super({
      ipfs_hash: IpfsHash
    }, value);
...
class Reaction extends _types.Struct {
  constructor(value) {
    super({
      id: ReactionId,
      created: Change,
...
class SocialAccount extends _types.Struct {
  constructor(value) {
    super({
      followers_count: _types.u32,
...
class BlogHistoryRecord extends _types.Struct {
  constructor(value) {
    super({
      edited: Change,
      old_data: BlogUpdate
...
class PostHistoryRecord extends _types.Struct {
  constructor(value) {
    super({
      edited: Change,
      old_data: PostUpdate
...
class CommentHistoryRecord extends _types.Struct {
  constructor(value) {
    super({
      edited: Change,
