...
export const ES_INDEX_URL = process.env.ES_INDEX_URL || 'http://testnet.subsocial.network:9200'
export const ES_INDEX_POSTS = process.env.ES_INDEX_POSTS || 'subsocial_posts'
export const ES_INDEX_COMMENTS = process.env.ES_INDEX_COMMENTS || 'subsocial_comments'
